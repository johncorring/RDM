...
function [x0, Lb, Ub] = set_bounds(motion, n)
%%=====================================================================
...
switch lower(motion)
    ...
    case 'rigid2dwv'
        x0 = [0,0,0,ones(1,n)];    %[ translation_x, translation_y,  rotation_theta]
        MAX_DX = 80;  MAX_DY = 80;   MAX_DTHETA = pi;
        MIN_DX = -80;  MIN_DY = -80;   MIN_DTHETA = -pi;
        Lb = [MIN_DX; MIN_DY; MIN_DTHETA;-1*ones(n,1)];
        Ub = [MAX_DX; MAX_DY; MAX_DTHETA;1*ones(n,1)];
    case 'affine2dwv'
        d = 2;
