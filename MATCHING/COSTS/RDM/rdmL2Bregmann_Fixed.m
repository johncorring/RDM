function [energy, grad] = rdmL2Bregmann_Fixed(param, optStruct)
    ...
    normals_after_nonrigid, optStruct.Vtarget, optStruct.tempWts, ...
    optStruct.targWts, optStruct.scale, optStruct.lambda);


    %compute energy plus regularization term
    energy = energy + optStruct.beta * bending;% + kappa1*sum((coeff_param - 1/(n1/d)).^2);
