...
function [f g gv gpb] = gab_costfunct2(A, B, Va, Vb, Ma, Mb, Pa, Pb, scale, lambda)
    [f1 g1 gv1 gpb1] = GaborTransform3(A, A, Va, Va, Ma, Ma, Pa, Pa, lambda, scale);
    [f2 g2 gv2 gpb2] = GaborTransform3(A, B, Va, Vb, Ma, Mb, Pa, Pb, lambda, scale);
    [f3] = GaborTransform3(B, B, Vb, Vb, Mb, Mb, Pb, Pb, lambda, scale);
    f = f1 - 2*f2 + f3;
    g = 2*g1 - 2*g2;
    gv = 2*gv1 - 2*gv2;
    gpb = 2*gpb1 - 2*gpb2;
